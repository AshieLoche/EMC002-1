                          ...
                          <?php foreach ($pokemons as $pokemon) { ?>
                            ...
                            <?php if (in_array($pokemon['id'], $likeList)): ?>
                              ...
                              <?php if (is_null($pokemon['adoption_time'])): ?>
                                ...
                                <div class="modal fade" id="AmierModals" tabindex="-1" aria-labelledby="pokemonModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content bg-dark text-light border-dark rounded-5">
                                      <div class="modal-header border-bottom pb-2 mb-3">
                                        <h5 class="modal-title display-3" id="pokemonModalLabel"><?php echo $pokemon['name']; ?></h5>
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <section class="pt-3 px-4 pb-5">
                                          <section class="card-title display-4 fs-2 mb-3">
                                          ...
                                          <form action="../components/likeProcess.php" method="POST" class="mt-3 d-flex justify-content-end">
                                            <input type="hidden" name="pokemonID" value="<?php echo $pokemon['id']; ?>">
                                            <button class="btn btn-outline-light border-0 p-0 px-2 heart" type="submit" name="heart" value="heart">
                                              <i class="card-header p-0 bi 
                                                <?php
                                  ...
                                  <section class="modal-dialog d-flex justify-content-center align-items-center m-0">
                                    ...
                                    <section class="modal-content bg-secondary">
                                      ...
                                      <section class="modal-footer bg-dark d-flex justify-content-start">
                                        ...
                                        <section class="col-12 d-flex justify-content-between p-3 m-0">
                                          <section class="card-title text-light d-flex align-items-center gap-2">
